export type View = 'discover' | 'predictions' | 'calendar' | 'community' | 'feed' | 'leaderboard' | 'accuracy' | 'library';
...
const views = new Set<View>(['discover', 'predictions', 'calendar', 'community', 'feed', 'leaderboard', 'accuracy', 'library']);
