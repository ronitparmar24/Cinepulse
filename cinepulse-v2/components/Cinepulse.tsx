...
export default function Cinepulse(){
 ...
 <main id="main" tabIndex={-1}>{view==='discover'||view==='calendar'?<Discovery search={search} calendar={view==='calendar'}/>:view==='predictions'?<PredictionHub/>:view==='contrarian'?<div className="section"><ContrarianDesk/></div>:view==='leaderboard'?<LeaderboardView/>:view==='accuracy'?<AccuracyView/>:view==='community'?<Community/>:view==='feed'?<ActivityFeed/>:<Library/>}</main>
