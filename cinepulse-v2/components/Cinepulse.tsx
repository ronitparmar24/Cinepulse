...
export default function Cinepulse(){
 ...
 <main id="main" tabIndex={-1}>{view==='discover'||view==='calendar'?<Discovery search={search} calendar={view==='calendar'}/>:view==='predictions'?<PredictionHub/>:view==='community'?<Community/>:view==='feed'?<ActivityFeed/>:<Library/>}</main>
